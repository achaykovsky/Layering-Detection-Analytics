...
spec = importlib.util.spec_from_file_location("layering_config", config_path)
layering_config = importlib.util.module_from_spec(spec)
spec.loader.exec_module(layering_config)
get_api_key = layering_config.get_api_key
