...
FastAPI microservice for detecting suspicious wash trading patterns in transaction data.
"""
...
# Create FastAPI app
app = FastAPI(
    title="Wash Trading Detection Service",
...
async def health_check() -> dict[str, str]:
    ...
    return {"status": "healthy", "service": "wash-trading-service"}
