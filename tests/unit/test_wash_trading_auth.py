"""
Unit tests for wash trading service API key authentication.

Tests authentication logic for the wash trading service endpoints.
"""
...
# Import wash trading main module
...
verify_api_key = wash_trading_main.verify_api_key
get_api_key = wash_trading_main.get_api_key
...
class TestVerifyApiKey:
    ...
    async def test_valid_api_key(self) -> None:
        ...
        with patch.object(wash_trading_main, "get_api_key", return_value=expected_key):
            # Act
    ...
    async def test_no_api_key_configured_allows_access(self) -> None:
        ...
        with patch.object(wash_trading_main, "get_api_key", return_value=None):
            # Act
...
class TestDetectEndpointAuth:
    ...
    async def test_detect_with_valid_api_key(
        ...
        with patch.object(wash_trading_main, "get_api_key", return_value=api_key):
